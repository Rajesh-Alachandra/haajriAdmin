...
function Menu() {
    ...
    return (
        <MenuList>
            <MenuItem sub>
                <MenuItemLink to="/home" icon="dashboard-fill" text="Dashboard" />
                {/* <MenuSub>
                    <MenuItem>
            ...
            <MenuItem>
                <MenuItemLink icon="user-fill-c" text="Clients" to="/clients" />
            </MenuItem>
            <MenuItem>
                <MenuItemLink icon="note-add-fill-c" text="Invoices" to="/invoices" />
            </MenuItem>
            <MenuItem>
                <MenuItemLink icon="alert-fill" to="/alerts" text="Alerts" />
            </MenuItem>
            <MenuItem>
                <MenuItemLink icon="cc-secure-fill" text="Schedules" to="/schedules" />
            </MenuItem>
            <MenuItem sub>
                <MenuItemLink icon="sign-inr-alt" text="Finance" onClick={menuToggle} sub />
                <MenuSub>
                    <MenuItem>
                        <MenuItemLink text="Earnings" to="/earnings" />
                    </MenuItem>
                    <MenuItem>
                        <MenuItemLink text="Expensices" to="/expensices" />
                    </MenuItem>
                </MenuSub>
            </MenuItem>
            <MenuItem>
                <MenuItemLink icon="package-fill" text="Packages" to="/packages" />
            </MenuItem>
            {/* <MenuItem>
                <MenuItemLink icon="chat-fill" text="Chats" to="/chats" />
            </MenuItem> */}
            <MenuItem>
                <MenuItemLink icon="inbox-in-fill" text="Inbox" to="/inbox" />
            </MenuItem>
            {/* <MenuItem sub>
