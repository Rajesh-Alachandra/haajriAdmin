    ...
    const inboxData = [
        {
            ...
            title: "Hiya",
            description:
                "Nostrud irure ex duis ea quis id quis ad et. Sunt qui esse pariatur duis deserunt mollit dolore cillum minim tempor enim.",
            status: "Promotions",
            time: "12:41 PM",
        },
        {
        ...
        },
        {
            ...
            description:
                "Duis ea quis id quis ad et. Sunt qui esse pariatur duis deserunt mollit dolore cillum minim tempor enim.",
            time: "12:01 PM",
        },
        {
            id: "uid04",
            ...
            description:
                "Elit aute irure tempor incididunt sint deserunt ut voluptate aute id deserunt nisi.",
            time: "11:41 PM",
            theme: "info",
        },
        {
                    ...
                    <Inbox.Menu>
                        {inboxMenuData.map((item, index) => (
                            ...
                            >
                                ...
                                {item.status && (
                                    <span className="nk-ibx-menu-badge">{item.status}</span>
                                )}
                            </Inbox.Menu.Item>
                        ))}
                    </Inbox.Menu>
                            ...
                            <Inbox.Tools.Item>
                                <Dropdown>
                                    <Dropdown.Toggle
                                        ...
                                        className="btn btn-md btn-zoom btn-icon"
                                    >
                                    ...
                                    <div className="d-flex flex-column">
                                        <div className="nk-ibx-item-title">
                                            ...
                                            <ul className="nk-ibx-item-tags">
                                                <li>
                                                    <span
                                                        className={`badge text-bg-${item.status === "Promotions"
                                                                ? "info-soft"
                                                                : item.status === "Updates"
                                                                    ? "warning-soft"
                                                                    : item.status === "Socials"
                    ...
                    <div className={inboxViewClasses} id="ibxView">
                        <div className="nk-ibx-head">
                            <Inbox.Tools>
                                <Inbox.Tools.Item>
                                    <button
                                        onClick={handleInboxHide}
                                        className="btn btn-md btn-zoom btn-icon toggle-ibx-view"
                                    >
                                        ...
                                        <MediaGroup className="nk-reply-desc">
                                            ...
                                            <MediaText className="nk-reply-info">
                                                <div className="nk-reply-author lead-text">
                                                    Leslie Alexander{" "}
                                                    <span className="date d-sm-none">14 Jan, 2020</span>
                                                </div>
                                                <Dropdown className="nk-reply-msg-info">
                                                    <Dropdown.Toggle
                                                        as={CustomDropdownToggle}
                                                        className="dropdown-toggle sub-text dropdown-indicator align-items-center"
                                                    >
                                                        to Mildred
                                                    </Dropdown.Toggle>
                                                    <Dropdown.Menu
                                                ...
                                                <div className="nk-reply-msg-excerpt">
                                                    I am facing problem as i can not select currency on
                                                    buy order page. Can you guys let me know what i am
