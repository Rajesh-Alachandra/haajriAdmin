...
import Schedules from '../Project/Schedules';
import Packages from '../Project/Packages';
import Alets from '../Project/Alets';
import Clients from '../Project/Clients';
import Invoices from '../Project/Invoices';
import Earnings from '../Project/Earnings';
import Expencies from '../Project/Expencies';
  ...
  return (
    <ScrollToTop>
      <Routes>
        ...
        <Route path="/alerts" element={<Alets />} />
        <Route path="/invoices" element={<Invoices />} />
        <Route path="/packages" element={<Packages />} />
        <Route path="/schedules" element={<Schedules />} />
        <Route path="/earnings" element={<Earnings />} />
        <Route path="/expensices" element={<Expencies />} />
